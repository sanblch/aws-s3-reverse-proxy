...
COPY ./ /go/src/github.com/velovec/aws-s3-reverse-proxy
WORKDIR /go/src/github.com/velovec/aws-s3-reverse-proxy

RUN go build -o aws-s3-reverse-proxy github.com/velovec/aws-s3-reverse-proxy && \
